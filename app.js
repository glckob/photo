...
const translations = {
    ...
    filenameModeLabel: { km: "៥. កំណត់​របៀប​ចំឈ្មោះ​ឯកសារ (Filename Mode):", en: "5. Set Filename Mode:" },
...
function setLanguage(lang) {
    ...
    // (*** កែប្រែ​នៅ​ទីនេះ: អាប់ដេត​សម្រាប់ Toggle ថ្មី ***)
    ...
    if (lang === 'en') {
        ...
        langToggleCheckbox.checked = false;
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // (*** កែប្រែ​នៅ​ទីនេះ: ប្រើ Checkbox សម្រាប់​ប្តូរ​ភាសា ***)
    const langToggleCheckbox = document.getElementById('lang-toggle-checkbox');
    ...
    // កំណត់​ភាសា​ដំបូង​ពេល​បើក​កម្មវិធី
